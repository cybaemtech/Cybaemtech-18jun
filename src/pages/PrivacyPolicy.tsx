...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-background legal-light-theme">
      <SEOHead
        title="Privacy Policy - CybaemTech"
        description="CybaemTech Privacy Policy. Learn how we collect, use, and protect your personal data in compliance with Indian data protection laws."
                ...
                <CardContent className="p-6 md:p-8">
                  <div className="prose max-w-none">
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-400 mb-2">&copy; 2025 CybaemTech Private Limited. All rights reserved.</p>
